    ...
    <section class="footer">
        <div class="home-container">
            <a href="mobile_home.php">
                <div class="home" style="margin:0px 15px">
        ...
        <div class="borrow-container">
            <a href="mobile_borrow.php">
                <div class="borrow" style="margin:0px 15px">
        ...
        <div class="return-container">
            <a href="mobile_return.php">
                <div class="return" style="margin:0px 15px">
        ...
        <div class="tool-container">
            <a href="mobile_tool.php">
                <div class="tool" style="margin:0px 15px">
        ...
        <div class="account-container">
            <a href="mobile_account.php">
                <div class="account" style="margin:0px 15px">
